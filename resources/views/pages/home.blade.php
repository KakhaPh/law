...
<div class="home_content">
  ...
  <div class="main__body__head">
      <div class="main__body__headbox__left">
          <div class="d-flex align-items-center ">
              ...
              <h3>საერთაშორისო სამეცნიერო გამოცემა სამართალი და მსოფლიო</h3>
        ...
        <div class="main__body__headbox__right d-flex flex-column justify-content-center align-items-center" style="background-image: url('{{ asset('storage/Images/bg-service-half.jpg')}}'); ">
            <h3>ინსტიტუტის მისია</h3>
    ...
    <div class="main__body__cont">
      <div class="main_body__item">
          <div class="main_body__item__title">
            ...
            <h5>პროფესიული საკვალიფიკაციო კურსები</h5>
          </div> 
      ...
      <div class="main_body__item">
        <div class="main_body__item__title">
          ...
          <h5>სამართლის სახელმძღვანელოები</h5>
        </div> 
      ...
      <div class="main_body__item">
        <div class="main_body__item__title">
          ...
          <h5>სამართლის სამეცნიერო სტატიები</h5>
        </div> 
        <p>ინსტიტუტი გამოსცემს საერთაშორისო რეფერირებად და რეცენზირებად ჟურნალს სამართალი და მსოფლიო, რომელიც აღიარებულია საერთაშორისო რეიტინგული სამეცნიერო ბაზების მიერ.</p>             
      </div>

      <div class="main_body__item">
        <div class="main_body__item__title">
          <i class="fa fa-globe"></i>
          <h5>იურისტების ბლოგი</h5>
        </div> 
        <p>ქართველ და უცხოელ იურისტებს, სტუდენტებს, ლექტორებსა და პრაქტიკოს მუშაკებს, შესაძლებლობა აქვთ აწარმოონ დისკუსია, გაცვალონ იდეები სამართლის სფეროში მიმდინარე აქტუალურ საკითხებზე.</p>             
      </div>

      <div class="main_body__item">
        <div class="main_body__item__title">
          <i class="fas fa-university"></i>
          <h5>ადვოკატის მომსახურება</h5>
        </div> 
        <p>ინსტიტუტი ახორციელებს იურიდიულ საკონსულტაციო მომსახურებას, გამოდის სასამართლოში ფიზიკური და იურიდიული პირების ინტერესების დასაცავად.</p>             
      </div>

      <div class="main_body__item">
        <div class="main_body__item__title">
          <i class="fas fa-chart-line"></i>
          <h5>სამეცნიერო პროექტები</h5>
        </div> 
  ...
  <div class="main__body__bottom">
    <div class="main__body__bottom-title">
        <h2>გჭირდებათ სამართლებრივი დახმარება? </h2>
        <h3>თქვენს სამსაუხრში პროფესიონალი იურისტები არიან</h3>
